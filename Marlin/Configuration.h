...
#define STRING_CONFIG_H_AUTHOR "(SPATTY, CR10 S5)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 136.1 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44.5, -8.0, -3.06 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 250), (Y_MAX_POS - 10), 10 }
